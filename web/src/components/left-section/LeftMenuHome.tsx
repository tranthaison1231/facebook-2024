...
import NavbarIcon from '../feature-icons/NavbarIcon'
import FeatureIconV10 from '../feature-icons/FeatureIconV10'
import FeatureIconV12 from '../feature-icons/FeatureIconV12'

const MENUS = [
  {
    label: 'Son Tung MTP',
    link: '/',
    icon: <Image src={avatar} alt="avatar" className="size-9 rounded-full object-cover" />
  },
