...
function CreateItem({ logoIcon, title, content, onClick }: ItemProps) {
  return (
    <div
      onClick={onClick}
      className="group/item relative mx-2 flex flex-row items-center rounded-xl px-2 py-1 font-normal hover:bg-gray-200"
    >
